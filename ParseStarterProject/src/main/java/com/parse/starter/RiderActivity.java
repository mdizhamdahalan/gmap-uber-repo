...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void checkForUpdates(){
        ...
        //where username equal to current username
        query.whereEqualTo("username", ParseUser.getCurrentUser().getUsername());
        //find where exists driver username
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null && objects.size() > 0){
                    ...
                    //verify that a driver is on their way
                    driverActive = true;
                    ...
                    query.findInBackground(new FindCallback<ParseUser>() {
                        ...
                        public void done(List<ParseUser> objects, ParseException e) {
                            if (e == null && objects.size() > 0){
                                ...
                                //get the users last know location and compare with drivers location
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnowLocation != null){
                                        ...
                                        //0.01 = arrived at users location
                                        if (distanceInMiles < 0.01){
                                            ...
                                            //we know we have a driver on users way
                                            ...
                                            //bounds object of array of markers
    ...
    public void callUber(View view){
        ...
        //if we have a requestActive we want to cancel it and delete it
        if (requestActive){
            //check if it is a active request in place
            ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Request");
            //where the username is equal to our current username
            query.whereEqualTo("username", ParseUser.getCurrentUser().getUsername());
            query.findInBackground(new FindCallback<ParseObject>() {
                @Override
                public void done(List<ParseObject> objects, ParseException e) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                Location lastKnowLocation = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);
                //if we have last location
                if (lastKnowLocation != null) {
                    //creates an object request on server
                    ParseObject request = new ParseObject("Request");
                    //puts username
                    request.put("username", ParseUser.getCurrentUser().getUsername());
                    //and the coordinates of user
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                //when the uber is created
                                requestActive=true;

                                //info for user to know the location of driver, 2 secs
                                checkForUpdates();
                            }
    ...
    //when user as give us permission
    @Override
    ...
    public void updateMap(Location location){
        //when users location updates we dont want to update the map because we want update the map using our new update method rather that center the map on the user
