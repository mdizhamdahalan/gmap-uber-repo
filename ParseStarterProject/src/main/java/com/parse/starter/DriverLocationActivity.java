...
import static com.parse.starter.R.id.map;
...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void acceptRequest(View view){
        ...
        //update the request over in parse, so that we know that as been accept, so it cant be accept for somebody else, and give driver directions
                        ...
                        for (ParseObject object : objects) {
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    //get directions to this new location(driving) via an intent
                                    if (e == null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //intent = getIntent();
        ...
        //Almost all movement methods require the Map object to have passed the layout process.
        //You can wait for this to happen using the addOnGlobalLayoutListener construct.
